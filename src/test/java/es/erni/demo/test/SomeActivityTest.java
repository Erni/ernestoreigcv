...
//		final ProfExpDetailsView detailsView = createMock(ProfExpDetailsView.class);
		...
		final DefaultView defaultView = createMock(DefaultView.class);
		...
		final Provider<DefaultMobileActivity> defaultMobileActivityProvider = new DefaultMobileActivityProvider(mainMenuView,placeController);
		final Provider<DefaultActivity> defaultActivityProvider = new DefaultActivityProvider(defaultView);
		...
		final MainContentActivityMapper activityMapper = new MainContentActivityMapper(new CareerOverviewActivityProvider(careerOverviewView),
				...
				publicationsDetailsActivityProvider, defaultMobileActivityProvider,
