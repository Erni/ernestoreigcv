...
public class MainMenuActivity extends AbstractActivity implements MainMenuView.Presenter {
	
  private final MainMenuView view;
  PlaceController placeController;

  public MainMenuActivity(MainMenuView view, PlaceController placeController) {
    this.view = view;
